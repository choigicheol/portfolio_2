    ...
    child: {
      ...
      "Strength.txt": {
        ...
        data: [
          ...
          "",
          "가장 최근 이 타이핑 이펙트의 경우에도 txt를 변경하면 이전 txt 문장이 잠깐 나타났다 사라지는 에러가 있었는데",
          "동작 시퀀스에 따라 useEffect, setState, 커스텀 hook, data 순서로 원인을 탐색했습니다.",
          "",
          "data에서 문장이 한개일때 해당 에러가 나타나지 않는것을 발견하고",
          "커스텀 hook의 실행 시간을 조절하는 setTimeout 함수들 중",
